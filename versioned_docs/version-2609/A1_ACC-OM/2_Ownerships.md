...
|-|-|-|-|
|ALLFIR LM   EPWW_ALL_CTR||G L   EPWW_G_CTR||
|ALLFIR H    EPWW_ALH_CTR||JL   EPWW_J_CTR||
|C L   EPWW_C_CTR||JR LM   EPWW_JR_CTR||
|D L   EPWW_D_CTR||NE LMH   EPWW_NE_CTR||
|DB+T LM   EPWW_DBT_CTR||T LM   EPWW_TM_CTR||
|DBF+G LM   EPWW_DBF_CTR||TC+J LM   EPWW_TCJ_CTR||
|DT LM   EPWW_DT_CTR||EFIR (NER+J+C)   EPWW_E_CTR||
|DTC LMH   EPWW_DTC_CTR||NFIR (BDFGNE+C)   EPWW_N_CTR||
|F L   EPWW_F_CTR||SFIR (TCJRE)   EPWW_S_CTR||
|FG LM   EPWW_FG_CTR||||
...
:::tip
NOTE: detailed sector ownerships should be based on below stated precedence rules and above stated website.
:::
